...
CFLAGS_MOD += -DMICROPY_BLUETOOTH_NIMBLE_CONTROLLER=1
...
LIB_SRC_C += $(NIMBLE_LIB_DIR)/nimble/transport/ram/src/ble_hci_ram.c
...
LIB_SRC_C += $(NIMBLE_LIB_DIR)/nimble/transport/uart/src/ble_hci_uart.c
