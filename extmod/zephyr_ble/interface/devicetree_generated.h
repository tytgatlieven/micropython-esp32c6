 ...
 *
 * DTS input file:
 *   /workdir/zephyr/build/zephyr/zephyr.dts.pre
 *
...
#define DT_N_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) fn(DT_N_S_chosen) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_aliases) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_cpus) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_flash_controller_0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_eeprom) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_i2c_100) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_spi_200) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_espi_300) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_uart) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_uart_1) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_rng) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_counter) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_ec_host_cmd_periph) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_gpio_800) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_udc0) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_sdl_dc) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_sdl_kscan)
#define DT_N_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) fn(DT_N_S_chosen, __VA_ARGS__) fn(DT_N_S_aliases, __VA_ARGS__) fn(DT_N_S_leds, __VA_ARGS__) fn(DT_N_S_cpus, __VA_ARGS__) fn(DT_N_S_flash_controller_0, __VA_ARGS__) fn(DT_N_S_eeprom, __VA_ARGS__) fn(DT_N_S_i2c_100, __VA_ARGS__) fn(DT_N_S_spi_200, __VA_ARGS__) fn(DT_N_S_espi_300, __VA_ARGS__) fn(DT_N_S_uart, __VA_ARGS__) fn(DT_N_S_uart_1, __VA_ARGS__) fn(DT_N_S_rng, __VA_ARGS__) fn(DT_N_S_counter, __VA_ARGS__) fn(DT_N_S_ec_host_cmd_periph, __VA_ARGS__) fn(DT_N_S_gpio_800, __VA_ARGS__) fn(DT_N_S_udc0, __VA_ARGS__) fn(DT_N_S_sdl_dc, __VA_ARGS__) fn(DT_N_S_sdl_kscan, __VA_ARGS__)
#define DT_N_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) fn(DT_N_S_chosen, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_aliases, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_leds, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_cpus, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_flash_controller_0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_eeprom, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_i2c_100, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_spi_200, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_espi_300, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_uart, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_uart_1, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_rng, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_counter, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_ec_host_cmd_periph, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_gpio_800, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_udc0, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_sdl_dc, __VA_ARGS__) DT_DEBRACKET_INTERNAL sep fn(DT_N_S_sdl_kscan, __VA_ARGS__)
...
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_ec_host_cmd_periph_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_ec_host_cmd_periph_ORD 6
...
#define DT_N_S_ec_host_cmd_periph_COMPAT_VENDOR_IDX_0_EXISTS 1
#define DT_N_S_ec_host_cmd_periph_COMPAT_VENDOR_IDX_0 "Zephyr-specific binding"
...
#define DT_N_S_ec_host_cmd_periph_P_compatible_IDX_0_STRING_TOKEN zephyr_sim_ec_host_cmd_periph
#define DT_N_S_ec_host_cmd_periph_P_compatible_IDX_0_STRING_UPPER_TOKEN ZEPHYR_SIM_EC_HOST_CMD_PERIPH
...
/*
 * Devicetree node: /sdl_kscan
 *
 * Node identifier: DT_N_S_sdl_kscan
 *
 * Binding (compatible = zephyr,sdl-kscan):
 *   $ZEPHYR_BASE/dts/bindings/kscan/zephyr,sdl-kscan.yaml
 *
 * (Descriptions have moved to the Devicetree Bindings Index
 * in the documentation.)
 */
...
/* Node's full path: */
#define DT_N_S_sdl_kscan_PATH "/sdl_kscan"

/* Node's name with unit-address: */
#define DT_N_S_sdl_kscan_FULL_NAME "sdl_kscan"

/* Node parent (/) identifier: */
#define DT_N_S_sdl_kscan_PARENT DT_N

/* Node's index in its parent's list of children: */
#define DT_N_S_sdl_kscan_CHILD_IDX 17

/* Helper macros for child nodes of this node. */
#define DT_N_S_sdl_kscan_FOREACH_CHILD(fn) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_SEP(fn, sep) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_VARGS(fn, ...) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_SEP_VARGS(fn, sep, ...) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_STATUS_OKAY(fn) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_STATUS_OKAY_SEP(fn, sep) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_STATUS_OKAY_VARGS(fn, ...) 
#define DT_N_S_sdl_kscan_FOREACH_CHILD_STATUS_OKAY_SEP_VARGS(fn, sep, ...) 

/* Node's dependency ordinal: */
#define DT_N_S_sdl_kscan_ORD 12

/* Ordinals for what this node depends on directly: */
#define DT_N_S_sdl_kscan_REQUIRES_ORDS \
	0, /* / */

/* Ordinals for what depends directly on this node: */
#define DT_N_S_sdl_kscan_SUPPORTS_ORDS /* nothing */

/* Existence and alternate IDs: */
#define DT_N_S_sdl_kscan_EXISTS 1
#define DT_N_ALIAS_kscan0            DT_N_S_sdl_kscan
#define DT_N_INST_0_zephyr_sdl_kscan DT_N_S_sdl_kscan
#define DT_N_NODELABEL_sdl_kscan     DT_N_S_sdl_kscan

/* Macros for properties that are special in the specification: */
#define DT_N_S_sdl_kscan_REG_NUM 0
#define DT_N_S_sdl_kscan_RANGES_NUM 0
#define DT_N_S_sdl_kscan_FOREACH_RANGE(fn) 
#define DT_N_S_sdl_kscan_IRQ_NUM 0
#define DT_N_S_sdl_kscan_COMPAT_MATCHES_zephyr_sdl_kscan 1
#define DT_N_S_sdl_kscan_COMPAT_VENDOR_IDX_0_EXISTS 1
#define DT_N_S_sdl_kscan_COMPAT_VENDOR_IDX_0 "Zephyr-specific binding"
#define DT_N_S_sdl_kscan_STATUS_okay 1

/* Pin control (pinctrl-<i>, pinctrl-names) properties: */
#define DT_N_S_sdl_kscan_PINCTRL_NUM 0

/* Generic property macros: */
#define DT_N_S_sdl_kscan_P_compatible {"zephyr,sdl-kscan"}
#define DT_N_S_sdl_kscan_P_compatible_IDX_0 "zephyr,sdl-kscan"
#define DT_N_S_sdl_kscan_P_compatible_IDX_0_STRING_TOKEN zephyr_sdl_kscan
#define DT_N_S_sdl_kscan_P_compatible_IDX_0_STRING_UPPER_TOKEN ZEPHYR_SDL_KSCAN
#define DT_N_S_sdl_kscan_P_compatible_IDX_0_EXISTS 1
#define DT_N_S_sdl_kscan_P_compatible_FOREACH_PROP_ELEM(fn) fn(DT_N_S_sdl_kscan, compatible, 0)
#define DT_N_S_sdl_kscan_P_compatible_FOREACH_PROP_ELEM_VARGS(fn, ...) fn(DT_N_S_sdl_kscan, compatible, 0, __VA_ARGS__)
#define DT_N_S_sdl_kscan_P_compatible_LEN 1
#define DT_N_S_sdl_kscan_P_compatible_EXISTS 1
#define DT_N_S_sdl_kscan_P_wakeup_source 0
#define DT_N_S_sdl_kscan_P_wakeup_source_EXISTS 1
...
#define DT_CHOSEN_zephyr_keyboard_scan            DT_N_S_sdl_kscan
...
#define DT_COMPAT_HAS_OKAY_zephyr_sdl_kscan 1
...
#define DT_N_INST_zephyr_sdl_kscan_NUM_OKAY 1
...
#define DT_FOREACH_OKAY_zephyr_sdl_kscan(fn) fn(DT_N_S_sdl_kscan)
#define DT_FOREACH_OKAY_VARGS_zephyr_sdl_kscan(fn, ...) fn(DT_N_S_sdl_kscan, __VA_ARGS__)
#define DT_FOREACH_OKAY_INST_zephyr_sdl_kscan(fn) fn(0)
#define DT_FOREACH_OKAY_INST_VARGS_zephyr_sdl_kscan(fn, ...) fn(0, __VA_ARGS__)
